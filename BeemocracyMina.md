...
#### Possible Exploits and Countermeasures
  ...
  * Exploit: Jurors selling their wallet keys (selling their entire anonymous reputation to special interest):
    ...
    * Countermeasures:
      ...
      * Now it is possible to use the wallet owner's biometrics to prove humanity and uniqueness without governance having to store the biometrics.
      ...
      * A device like this would not work for anyone but the owner and so could not be sold without also a copy of the owners fingerprint.
      ...
      * What we are reaching for is an open source a.i. witness that is certified by governance to tell the truth but will only answer questions when asked by the owner?
      ...
      * The idea is a hardware wallet with onboard a.i. that is trained to recognize only its owner.
      * The device would have a camera (Face Recognition), a microphone (Voice Recognition), a fingerprint reader, and a keyboard for input.
