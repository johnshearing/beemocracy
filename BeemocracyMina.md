...
#### Possible Exploits and Counter Measures
  * Exploit: Loading the Random Jury Pool With Elite Scout wallets Under The Control Of A Special Interest
    ...
    * Exploit: Jurors selling their wallet keys (Their entire anonymous reputation):
      ...
      * Might be interesting to have a hardware wallet that requires a 25th word which is taken from a fingerprint reader.
        ...
        * One could just get the values generated by a different fingerprint read of the same type but not connected to the hardware wallet, so this idea won't work.
      * Sounds like a job for the a.i. controlled hardware wallet [described at this link here](https://github.com/johnshearing/A.i.-Classifiers-Zero-Knowledge-Proofs-Without-Zero-Knowledge-Cryptography).
        * I will think this through more and then add more detail about it tomorrow.
