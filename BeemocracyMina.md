...
#### Possible Exploits and Countermeasures
  ...
  * Exploit: Jurors selling their wallet keys (selling their entire anonymous reputation to special interest):
    ...
    * Countermeasures:
      ...
      * A device like this will not work for anyone but the owner and so **cannot be sold without also selling a copy of the owners fingerprint**. 
