...
#### **Modeling Mina Governance On Bee Democracy**  
  ...
  * Abstract
    ...
    * What Mina can learn from Cardano Governance:
      ...
      * So for Mina, the three branches of government would be the block producers and snark workers, the courts to decide governance proposals, and the Constitutional Committee to ensure that no approved proposal violates the Mina constitution. 
...
#### Possible Exploits
  * Loading the Random Jury Pool With Elite Scouts Under The Control Of A Special Interest
    ...
    * Consider requiring a zero knowledge demonstration of human memory recall for the 24 word passphrase of the hardware wallet which identifies the Mina account for the anonymous reputation identity.
      ...
      * The human then signs a message with Ledger hardware wallet to prove that the device does indeed control the Mina account associated with the anonymous reputation identity.
