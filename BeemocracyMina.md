...
#### Possible Exploits and Countermeasures
  ...
  * Exploit: Jurors selling their wallet keys (selling their entire anonymous reputation to special interest):
    ...
    * Countermeasures:
      ...
      * A HW wallet with fingerprint reader makes it possible to use the wallet owner's biometrics to prove humanity and uniqueness without governance having to store the biometrics.
