...
#### **Modeling Mina Governance On Bee Democracy**  
  ...
  * Abstract
    ...
    * What Mina can learn from Cardano Governance:
      * Mina uses a modified version of Cardano's Ouroboros consensus mechanism, so it follows that governance will develop the same structure and the same problems if there is no intervention.
      ...
      * So for Mina, the three branches of government would be the stakepool operators AKA the block producers, the jury system AKA the judiciary, and the Constitutional Committee 
