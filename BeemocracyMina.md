...
#### Possible Exploits and Countermeasures
  ...
  * Exploit: Jurors selling their wallet keys (selling their entire anonymous reputation to special interest):
    ...
    * Countermeasures:
      ...
      * A device like this will not work for anyone but the owner and so **cannot be sold without also a copy of the owners fingerprint**. 
      ...
      * The owner would need to keep a copy of their own finger print in case their finger becomes damaged.
      ...
      * There is no hard prevention from setting up more than one device so that a single human can control more than one anonymous reputation but the cost of setting up the device and the majority of incentives line up against this. Furthermore, that the device is locked to a single human prevents setting up multiple anonymous reputations on an industrial scale.
      * Still, we could take this idea even further and make it almost impossible for a single human to setup more than one device all without collecting biometric or engaging in KYC.
      ...
      * The device would also be loaded with an open source large language model (an a.i.).
